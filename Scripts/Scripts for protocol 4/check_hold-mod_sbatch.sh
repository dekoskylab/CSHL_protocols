...
#SBATCH --mail-user=afahad@mgh.harvard.edu
...
do
        ...
        cat large_jobsubmit | awk -v file1=$file1 -v file2=$file2 -v prefix=$prefix -v barcodes=$barcodes '{print $0}; END {print "bash qualityfilter_script_v2.0.sh " file1 " " file2 " " prefix " " barcodes}' > $prefix"QFjobsubmit"
