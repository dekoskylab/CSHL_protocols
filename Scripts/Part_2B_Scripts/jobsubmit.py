...
#Replace the amino acid sequence for the heavy and light chain gene to be analyzed in the command below
cmd3= "awk '{print match($1,/[ACDEFGHIKLMNPQRSTVWY]VQL|Q[ACDEFGHIKLMNPQRSTVWY]QL|QV[ACDEFGHIKLMNPQRSTVWY]L|QVQ[ACDEFGHIKLMNPQRSTVWY]/)}' "+VDJaa_fname
